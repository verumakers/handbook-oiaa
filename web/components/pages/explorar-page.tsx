...
export function ExplorarPage() {
  return <article className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-12 lg:py-24">
    <PageHeader {...page} />
    <PageContents items={[{ href: '#conceitos', label: 'Conceitos' }, { href: '#tipos-variavel', label: 'Tipos de variável' }, { href: '#graficos', label: 'Gráficos' }, { href: '#perguntas', label: 'Perguntas e diário' }]} />
    <section className="mt-12 grid gap-4 sm:grid-cols-2" id="conceitos" aria-label="Conceitos fundamentais">
    ...
    <div className="mt-16" id="perguntas"><QuestionList questions={explorarContent.questions} /></div>
    <div className="mt-8"><ExperimentLog entries={explorarContent.journal} title="Diário · hipótese e evidência observada" /></div>
    <PhaseNavigation current="/explorar" />
  </article>;
}
