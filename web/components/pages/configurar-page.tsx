...
export function ConfigurarPage() {
  return <article className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-12 lg:py-24">
    <PageHeader {...page} />
    <PageContents items={[{ href: '#partes-experimento', label: 'Treino, validação e teste' }, { href: '#complexidade', label: 'Complexidade' }, { href: '#tradeoffs', label: 'Seletores' }, { href: '#plano', label: 'Plano de experimento' }]} />
    <section className="mt-12 grid gap-4 lg:grid-cols-3" aria-label="Partes do experimento" id="partes-experimento">
    ...
    <div className="mt-12" id="plano"><ExperimentLog entries={configurarContent.plan} title="Plano neutro de experimento" /></div>
    <PhaseNavigation current="/configurar" />
  </article>;
}
